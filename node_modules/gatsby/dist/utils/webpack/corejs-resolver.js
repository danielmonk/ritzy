...
class CoreJSResolver {
  constructor() {
    ...
    this._coreJSNodeModulesPath = path.dirname(path.dirname(require.resolve(`core-js`)));
  }
  ...
  resolve(request, resolveContext, callback) {
    ...
    return void this._resolver.doResolve(this._target, { ...request,
  ...
  apply(resolver) {
    ...
    resolver.getHook(`described-resolve`).tapAsync(`CoreJSResolver`, this.resolve.bind(this));
  }
